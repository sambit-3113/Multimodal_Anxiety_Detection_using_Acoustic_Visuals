...
class DepressionDetector(BaseNet):
    ...
    def __init__(self, d=256, l=6, t_downsample=4):
        ...
        self.norm_va = nn.LayerNorm(d)   # For visual branch
    ...
    def feature_extractor(self, x):
        ...
        ua = self.a_encoder(xa)                                                 ## as per paper there is positionl encoing before this line. 
        ...
        # uua = self.cross_av(qa, kv, vv)[0]    #it was previously there
        # uuv = self.cross_va(qv, ka, va)[0]    #it was previously there

        # =======================
        # Cross Attention
        # =======================
        cross_av_out = self.cross_av(qa, kv, vv)[0]
        ...
        # =======================
        uua = self.norm_av(cross_av_out + ua)
        uuv = self.norm_va(cross_va_out + uv)
